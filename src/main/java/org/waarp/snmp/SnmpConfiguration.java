...
public class SnmpConfiguration {
   ...
   * XmlDecl(XmlType.STRING, SNMP_SECURITY_PRIV_PROTOCOL),
   * new XmlDecl(XmlType.STRING, SNMP_SECURITY_PRIV_PASSPHRASE)
   *
   ...
   * XmlDecl(XmlType.STRING, SNMP_TARGET_DOMAIN), one of
   * (Udp/Tcp)Ipv(4/6)[z] new XmlDecl(XmlType.STRING, SNMP_TARGET_ADDRESS), new
   * XmlDecl(XmlType.INTEGER,
